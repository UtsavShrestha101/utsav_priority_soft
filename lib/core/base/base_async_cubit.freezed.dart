...
mixin _$AsyncValue<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T? data, String message) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T? data, String message)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$AsyncErrorImpl<T> implements _AsyncError<T> {
  const _$AsyncErrorImpl({this.data, required this.message});
  ...
  @override
  String toString() {
    return 'AsyncValue<$T>.error(data: $data, message: $message)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(this.data, message);
  }
...
abstract class _AsyncError<T> implements AsyncValue<T> {
  const factory _AsyncError({final T? data, required final String message}) =
      _$AsyncErrorImpl<T>;
